...
export default function WritePage() {
  ...
  const [newCatParentId, setNewCatParentId] = useState(""); // 상위 카테고리 ID
  const [newCatSortOrder, setNewCatSortOrder] = useState("0"); // 신규 정렬 순서
